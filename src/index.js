export function eliminateAnonymous () {
  ...
  var replacements = [
    ...
    [ /(perfor\$\$anonymous\$\$g)/g, "performing" ],
    [ /(\$\$anonymous\$\$aterial)/g, "Material" ],
    [ /(lu\$\$anonymous\$\$ance)/g, "luminance" ],
    [ /(consu\$\$anonymous\$\$g)/g, "consuming" ],
    ...
    [ /(stem\$\$anonymous\$\$g)/g, "stemming" ],
    [ /(deter\$\$anonymous\$\$)/g, "determin" ],
    [ /(eli\$\$anonymous\$\$at)/g, "eliminat" ],
    [ /(THAN\$\$anonymous\$\$S)/g, "THANKS" ],
    [ /(\$\$anonymous\$\$odule)/g, "Module" ],
    [ /(INS\$\$anonymous\$\$D)/g, "INSTEAD" ],
    [ /(Ins\$\$anonymous\$\$d)/g, "Instead" ],
    [ /(ins\$\$anonymous\$\$d)/g, "instead" ],
    [ /(THAN\$\$anonymous\$\$)/g, "THANK" ],
    [ /(\$\$anonymous\$\$evin)/g, "Kevin" ],
    [ /(\$\$anonymous\$\$inda)/g, "Kinda" ],
    [ /(is\$\$anonymous\$\$ey)/g, "isKey" ],
    [ /(\$\$anonymous\$\$ouse)/g, "Mouse" ],
    [ /(\$\$anonymous\$\$athf)/g, "Mathf" ],
    [ /(I\$\$anonymous\$\$GUI)/g, "IMGUI" ],
    [ /(co\$\$anonymous\$\$g)/g, "coming" ],
    [ /(HO\$\$anonymous\$\$E)/g, "HOME" ],
    [ /(O\$\$anonymous\$\$FG)/g, "OMFG" ],
    [ /(\$\$anonymous\$\$eep)/g, "Keep" ],
    [ /(\$\$anonymous\$\$ath)/g, "Math" ],
    [ /(\$\$anonymous\$\$esh)/g, "Mesh" ],
    [ /(\$\$anonymous\$\$ove)/g, "Move" ],
    [ /(\$\$anonymous\$\$ode)/g, "Mode" ],
    [ /(\$\$anonymous\$\$ost)/g, "Most" ],
    [ /(\$\$anonymous\$\$ch)/g, "teach" ],
    [ /(\$\$anonymous\$\$in)/g, "Min" ],
    [ /(\$\$anonymous\$\$ax)/g, "Max" ],
    [ /(\$\$anonymous\$\$ey)/g, "Key" ],
    [ /(ND\$\$anonymous\$\$)/g, "NDK" ],
